...
declare namespace chrome.contextMenus {
	 ...
	 * function() {...};
	 */
    export function create(createProperties: CreateProperties, callback?: () => void): number;
	/**
...
declare namespace chrome.runtime {
	...
	export function restartAfterDelay(delay: number, callback?: (window: Window) => void): void;
